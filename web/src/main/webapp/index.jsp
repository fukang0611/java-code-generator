...
<head>
    ...
    <!-- VENDOR CSS -->
    <link rel="stylesheet" href="${ctx}/libs/assets/vendor/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="${ctx}/libs/assets/vendor/font-awesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="${ctx}/libs/assets/vendor/linearicons/style.css">
    <link rel="stylesheet" href="${ctx}/libs/assets/vendor/metisMenu/metisMenu.css">
    <link rel="stylesheet"
          href="${ctx}/libs/assets/vendor/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css">
    <link rel="stylesheet" href="${ctx}/libs/assets/vendor/chartist/css/chartist.min.css">
    <link rel="stylesheet" href="${ctx}/libs/assets/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.css">
    <link rel="stylesheet" href="${ctx}/libs/assets/vendor/toastr/toastr.min.css">
    <!-- MAIN CSS -->
    <link rel="stylesheet" href="${ctx}/libs/assets/css/main.css">
    <!-- GOOGLE FONTS -->
    <link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700" rel="stylesheet">
    <!-- ICONS -->
    <link rel="apple-touch-icon" sizes="76x76" href="${ctx}/libs/assets/img/apple-icon.png">
    <link rel="icon" type="image/png" sizes="96x96" href="${ctx}/libs/assets/img/favicon.png">
</head>
...
<div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-brand">
                <a href="${ctx}/index.jsp">
                    <img src="${ctx}/libs/assets/img/logo.png" alt="DiffDash Logo" class="img-responsive logo">
                </a>
            </div>
            <!-- end logo -->
                                    ...
                                    <a href="#">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="text">Your campaign <strong>Holiday Sale</strong> is starting
                                                    to engage potential customers.</p>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <p class="text">Website visits from Facebook is 27% higher than last
                                                    week.</p>
    ...
    <div id="left-sidebar" class="sidebar">
        ...
        <div class="sidebar-scroll">
            <div class="user-account">
                <img src="${ctx}/libs/assets/img/user.png" class="img-responsive img-circle user-photo"
            ...
            <nav id="left-sidebar-nav" class="sidebar-nav">
                <ul id="main-menu" class="metismenu">
                    <li class="active"><a href="${ctx}/index.jsp"><i class="lnr lnr-home"></i>
                        <span>Dashboard</span></a></li>
                    <li class="">
                        <a href="#uiElements" class="has-arrow" aria-expanded="false"><i class="lnr lnr-magic-wand"></i>
                            <span>UI Elements</span></a>
                        <ul aria-expanded="true">
                            <li class=""><a href="${ctx}/view/admin/ui-tabs.html">Tabs</a></li>
                            <li class=""><a href="${ctx}/view/admin/ui-buttons.html">Buttons</a></li>
                            <li class=""><a href="${ctx}/view/admin/ui-bootstrap.html">Bootstrap UI</a></li>
                            <li class=""><a href="${ctx}/view/admin/ui-icons.html"><span>Icons</span></a></li>
                        </ul>
                    </li>
                    <li class="">
                        <a href="#subPages" class="has-arrow" aria-expanded="false"><i class="lnr lnr-file-empty"></i>
                            <span>Pages</span></a>
                        <ul aria-expanded="true">
                            <li class=""><a href="${ctx}/view/generator/generator.jsp">Code Generator</a></li>
                            <li class=""><a href="${ctx}/view/admin/page-profile.html">User Profile</a></li>
                            <li class=""><a href="${ctx}/view/admin/page-login.html">Login</a></li>
                            <li class=""><a href="${ctx}/view/admin/page-register.html">Register</a></li>
                            <li class=""><a href="${ctx}/view/admin/page-lockscreen.html">Lockscreen</a></li>
                            <li class=""><a href="${ctx}/view/admin/page-forgot-password.html">Forgot Password</a></li>
                            <li class=""><a href="${ctx}/view/admin/page-404.html">Page 404</a></li>
                            <li class=""><a href="${ctx}/view/admin/page-500.html">Page 500</a></li>
                        </ul>
                    </li>
                    <li class="">
                        <a href="#forms" class="has-arrow" aria-expanded="false"><i class="lnr lnr-pencil"></i> <span>Forms</span></a>
                        <ul aria-expanded="true">
                            <li class=""><a href="${ctx}/view/admin/forms-validation.html">Form Validation</a></li>
                            <li class=""><a href="${ctx}/view/admin/forms-advanced.html">Advanced Form Elements</a></li>
                            <li class=""><a href="${ctx}/view/admin/forms-basic.html">Basic Form Elements</a></li>
                            <li class=""><a href="${ctx}/view/admin/forms-dragdropupload.html">Drag &amp; Drop
                                Upload</a></li>
                            <li class=""><a href="${ctx}/view/admin/forms-texteditor.html">Text Editor</a></li>
                        </ul>
                    </li>
                    <li class="">
                        <a href="#charts" class="has-arrow" aria-expanded="false"><i class="lnr lnr-chart-bars"></i>
                            <span>Charts</span></a>
                        <ul aria-expanded="true">
                            <li class=""><a href="${ctx}/view/admin/charts-chartist.html">Chartist</a></li>
                            <li class=""><a href="${ctx}/view/admin/charts-sparkline.html">Sparkline Chart</a></li>
                        </ul>
                    </li>
                    <li class=""><a href="${ctx}/view/admin/notifications.html"><i class="lnr lnr-alarm"></i> <span>Notifications</span>
                        <span class="badge bg-danger">15</span></a></li>
                    <li class=""><a href="${ctx}/view/admin/typography.html"><i class="lnr lnr-text-format"></i> <span>Typography</span></a>
                    </li>
                </ul>
            </nav>
            <div style="padding: 30px; text-align: center;">
                <h2 style="font-size: 16px; margin-bottom: 15px; font-weight: 700;">Other Similar Template</h2>
                <a href="https://www.themeineed.com/downloads/klorofil-pro-bootstrap-admin-dashboard-template/?utm_source=diffdash&utm_medium=template&utm_campaign=KlorofilPro"
                   target="_blank"><img src="${ctx}/libs/assets/img/klorofilpro.png" class="img-responsive thumbnail"
                                        alt=""></a>
                <a href="https://www.themeineed.com/downloads/klorofil-pro-bootstrap-admin-dashboard-template/?utm_source=diffdash&utm_medium=template&utm_campaign=KlorofilPro"
                   target="_blank" class="btn btn-primary">VIEW DEMO</a>
            </div>
        </div>
    </div>
    <!-- END LEFT SIDEBAR -->
    ...
    <div id="main-content">
        <div class="container-fluid">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="number-chart">
                                <div class="mini-stat">
                                    ...
                                    <p class="text-muted"><i class="fa fa-caret-up text-success"></i> 19% compared to
                                        last week</p>
                                </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="number-chart">
                                <div class="mini-stat">
                                    ...
                                    <p class="text-muted"><i class="fa fa-caret-up text-success"></i> 24% compared to
                                        last week</p>
                                </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="number-chart">
                                <div class="mini-stat">
                                    ...
                                    <p class="text-muted"><i class="fa fa-caret-up text-success"></i> 44% compared to
                                        last week</p>
                                </div>
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="number-chart">
                                <div class="mini-stat">
                                    ...
                                    <p class="text-muted"><i class="fa fa-caret-down text-danger"></i> 6% compared to
                                        last week</p>
                                </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="panel-content">
                            ...
                            <ul class="list-unstyled list-referrals">
                                <li>
                                    <p><span class="value">3,454</span><span
                                            class="text-muted">visits from Facebook</span></p>
                                    <div class="progress progress-xs progress-transparent custom-color-blue">
                                        <div class="progress-bar" data-transitiongoal="87"></div>
                                    </div>
                                </li>
                                <li>
                                    <p><span class="value">2,102</span><span
                                            class="text-muted">visits from Twitter</span></p>
                                    <div class="progress progress-xs progress-transparent custom-color-purple">
                                        <div class="progress-bar" data-transitiongoal="34"></div>
                                    </div>
                                </li>
                                <li>
                                    <p><span class="value">2,874</span><span
                                            class="text-muted">visits from Affiliates</span></p>
                                    <div class="progress progress-xs progress-transparent custom-color-green">
                                        <div class="progress-bar" data-transitiongoal="67"></div>
                                    </div>
                                </li>
                                <li>
                                    <p><span class="value">2,623</span><span
                                            class="text-muted">visits from Search</span></p>
            ...
            <div class="dashboard-section">
                ...
                <div class="panel-content">
                    ...
                    <div class="action-buttons">
                        <a href="#" class="btn btn-primary"><i class="fa fa-plus-circle"></i> Add Budget</a> <a href="#"
                                                                                                                class="btn btn-default"><i
                            class="fa fa-file-text-o"></i> View Campaign Details</a>
                    </div>
                </div>
            </div>
            <!-- END CAMPAIGN -->
            ...
            <div class="dashboard-section no-margin">
                <div class="section-heading clearfix">
                    <h2 class="section-title"><i class="fa fa-user-circle"></i> Social <span class="section-subtitle">(7 days report)</span>
                    </h2>
    ...
    <footer>
        <p class="copyright">&copy; 2019 <a href="https://www.baidu.com" target="_blank">FUKANG</a>. 版权没有.</p>
    </footer>
</div>
<!-- END WRAPPER -->
<!-- Javascript -->
<script src="${ctx}/libs/assets/vendor/jquery/jquery.min.js"></script>
<script src="${ctx}/libs/assets/vendor/bootstrap/js/bootstrap.min.js"></script>
<script src="${ctx}/libs/assets/vendor/metisMenu/metisMenu.js"></script>
<script src="${ctx}/libs/assets/vendor/jquery-slimscroll/jquery.slimscroll.min.js"></script>
<script src="${ctx}/libs/assets/vendor/jquery-sparkline/js/jquery.sparkline.min.js"></script>
<script src="${ctx}/libs/assets/vendor/bootstrap-progressbar/js/bootstrap-progressbar.min.js"></script>
<script src="${ctx}/libs/assets/vendor/chartist/js/chartist.min.js"></script>
<script src="${ctx}/libs/assets/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.min.js"></script>
<script src="${ctx}/libs/assets/vendor/chartist-plugin-axistitle/chartist-plugin-axistitle.min.js"></script>
<script src="${ctx}/libs/assets/vendor/chartist-plugin-legend-latest/chartist-plugin-legend.js"></script>
<script src="${ctx}/libs/assets/vendor/toastr/toastr.js"></script>
<script src="${ctx}/libs/assets/scripts/common.js"></script>
<script>
    $(function () {
